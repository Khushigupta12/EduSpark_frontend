...
function Form() {
    ...
    switch (name) {
      ...
      case "FatherNumber":{
        if (
          ...
          setErrors({
            ...errors,
            FatherNumber: "Enter a valid Father's Number",
          });
        } else {
      ...
      case "MotherNumber":{
        if (
          ...
          setErrors({
            ...errors,
            MotherNumber: "Enter a valid Mother's Number",
          });
        } else {
      ...
      case "SchoolNumber":{
        if (
          ...
          setErrors({
            ...errors,
            SchoolNumber: "Enter a valid School Number",
          });
        } else {
  ...
  async function handleClick(e) {
    ...
    if (Object.keys(errors).length === 5 && count == 21) {
      console.log(Object.keys(input).length);
      Axios.post(`https://eduspark-backend.onrender.com/api/v1/`, data).then(
        clearState(),
        alert("Details Registed Successfully!")
      );
    } else{
      console.log(data);
